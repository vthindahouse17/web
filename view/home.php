...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-9">
      ...
      <div class="row-col-3">
        <?php $product_result = hang_hoa_select_all_home() ?>
        <?php foreach ($product_result as $key => $value) : ?>
          <div class="product-card">
            <a href="./index.php?source=sp_detail&ma_hh=<?= $value['ma_hh'] ?>"><img src=".<?= $value['hinh'] ?>" alt="" class="product-image" style="margin-bottom: 12px;" /></a>
            <div class="product-name" style="font-size: 18px;font-weight: bold;margin-bottom: 5px; width: 200px; white-space: nowrap; overflow: hidden;text-overflow: ellipsis; ">
              <a href="./index.php?source=sp_detail&ma_hh=<?= $value['ma_hh'] ?>"><?= $value['ten_hh'] ?></a>
            </div>
            <div>
              <del class="product-price">$<?= $value['don_gia'] ?></del>
              <span class="product-price">$<?= ($value['don_gia'] - ($value['don_gia'] * ($value['giam_gia'] / 100))) ?></span>
            </div>
