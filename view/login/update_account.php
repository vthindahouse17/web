...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <?php
            ?>
            <form action="./view/login/progess_update_account.php" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <?php
                    $ma_kh = $_SESSION['user']['ma_kh'];
                    $khach_hang_result = khach_hang_select_by_id($ma_kh); ?>
                    <div class="form-group">
                        <input type="hidden" value="<?= $khach_hang_result['ma_kh'] ?>" name="ma_kh">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="old_image" value="<?= $khach_hang_result['hinh'] ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <button class="btn btn-primary mt-2" type="reset">Nhập lại</button>
                </div>
            </form>
            <hr />
        </div>
